...
public class DriveCommands {
  ...
  public static Command driveToPoseCommand(Drive drive, Supplier<Pose2d> pose) {
    return Commands.startEnd(() -> drive.setAutoAlignPosition(pose.get()), drive::disableAutoAlign);
  }

  public static Command headingAlignCommand(Drive drive, Supplier<Rotation2d> rotation) {
    return Commands.startEnd(() -> drive.setHeadingGoal(rotation), drive::clearHeadingGoal);
  }
}
